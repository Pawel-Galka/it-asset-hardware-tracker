...
namespace HardwareTracker.Migrations
{
    ...
    [Migration("20260915123801_AddEmployeeDatesAndOffboarding")]
    partial class AddEmployeeDatesAndOffboarding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HardwareTracker.Models.AssignmentHistory", b =>
                {
                    ...
                    // Composite index supports fast chronological tracking queries per physical asset.
            ...
            modelBuilder.Entity("HardwareTracker.Models.Employee", b =>
                {
                    ...
                    // Filtered index speeds up active employee lookups across the UI layer.
